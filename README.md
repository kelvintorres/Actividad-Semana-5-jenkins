...
When our app is loaded it will load `script.js` which will use the browser [fetch API](https://developer.mozilla.org/en-US/docs/Web/API/fetch) to query the `/usuario` route on our Node server and get the employee information from out PostgreSQL database.
